...
jQuery(document).ready(function() {
  jQuery.widget('ui.cont_logger', {
    ...
    _create: function() {
      ...
      // redefine the alert function so that we would not use it by
      // mistake
      alert = function(msg) {
    ...
    log: function(message, error) {
      ...
      // ownName = ownName.substr('function '.length); // trim off
      // 'function '
      // ownName = ownName.substr(0,ownName.indexOf('(')); // trim off
