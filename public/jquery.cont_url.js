      ...
      jQuery.fn.reload = function() {
        ...
        jQuery.ajax({
          ...
          error: function(XMLHttpRequest, textStatus, errorThrown) {
            jQuery.log('ajax error: ' + errorThrown + ',' + textStatus + ',' +
          ...
          return this.each(function() {
            ...
            w_input.autocomplete({
              ...
              select: function(evt, ui) {
                fake_use(evt);
                jQuery.log(ui.item ? (w_input + ' selected: ' + ui.item.value +
                    ' aka ' + ui.item.id) : 'Nothing selected, input was ' +
                    this.value, false);
              },
              change: function(evt, ui) {
                fake_use(evt);
                jQuery.log(ui.item ? (w_input + ' change: ' + ui.item.value +
                    ' aka ' + ui.item.id) : 'Nothing selected, input was ' +
                    this.value, false);
              }
            });
