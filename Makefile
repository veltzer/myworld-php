...
install:
	...
	$(Q)sudo cp $(MYWORLD_PLUGIN_NAME)/src/utils.php $(WEB_DIR_PUBLIC) # copy support code
	$(Q)sudo cp private/movies.js $(MYWORLD_PLUGIN_FULL_DIR)/javascript
	$(Q)sudo cp private/ux/RowExpander.js $(MYWORLD_PLUGIN_FULL_DIR)/javascript
	$(Q)sudo cp private/GetData.php $(WEB_DIR_PUBLIC) # copy support code
	$(Q)sudo cp private/movies.php $(WEB_DIR_PUBLIC) # copy support code
