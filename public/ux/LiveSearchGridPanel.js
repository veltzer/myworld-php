...
Ext
    .define(
        'Ext.ux.LiveSearchGridPanel',
        {
          ...
          /**
           * @private The row index of the first search, it could change if next
          ...
          // Component initialization override: adds the top and bottom toolbars
          // and setup headers renderer.
          ...
          // afterRender override: it adds textfield and statusbar reference and
          // start monitoring keydown events in textfield input
          ...
          /**
           * In normal mode it returns the value with protected regexp
           * characters. In regular expression mode it returns the raw value
           * except if the regexp is invalid.
           *
           * @return {String} The value to process or null if the textfield
           *         value is blank or invalid.
           * @private
           */
                  ...
                  .each(
                      function(record, idx) {
                        ...
                        while (td) {
                          ...
                          // replace wrap matched string in a span
